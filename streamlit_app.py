...
def render_exec_andromeda_gap():
    ...
    st.markdown('<div class="minimal-pipe-wrap"><p class="minimal-note"><b>Andromeda เป็นตัวเร่ง</b> แต่เชื้อเพลิงคือ Creative + Offer และเข็มทิศคือ Data Signal ถ้าสองส่วนนี้ยังไม่ชัด ระบบอาจเรียนรู้จาก Click / Message มากกว่า Buyer Signal</p>', unsafe_allow_html=True)
