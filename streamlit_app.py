...
def render_theme():
    st.markdown(
        ...
        .insight-card { min-height: 130px; margin-top: 18px; }
...
# =========================================================
def render_footer():
    st.markdown('<div class="footer-note">Modular Board v0.4 · Separated Module Blocks · TOP Funnel CI-first</div>', unsafe_allow_html=True)
